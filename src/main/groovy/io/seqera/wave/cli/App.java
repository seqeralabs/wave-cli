...
public class App implements Runnable {
    ...
    static public String[] makeArgs(String[] args) {
    ...
    protected void defaultArgs() {
        ...
        if( isEmpty(waveEndpoint) && System.getenv().containsKey("WAVE_ENDPOINT") ) {
            ...
            waveEndpoint = WaveClient.DEFAULT_ENDPOINT;
        }
    ...
    protected WaveClient client() {
        return new WaveClient().withEndpoint(waveEndpoint);
    }
    ...
    public void inspect() {
        final WaveClient client = client();
